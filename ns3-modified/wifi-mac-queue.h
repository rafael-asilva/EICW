...
protected:
  ...
  //--------------------------------------------------------------------------------------------------------
  // Added by Rafael Araujo in Dec 2015 to monitor when MAC Queue is Full and Drop or Packet is removed in timeout
  //--------------------------------------------------------------------------------------------------------
  TracedCallback<Ptr<const Packet> > m_fullQueueTrace;
  TracedCallback<Ptr<const Packet> > m_packetTimeoutTrace;
  //--------------------------------------------------------------------------------------------------------
};
